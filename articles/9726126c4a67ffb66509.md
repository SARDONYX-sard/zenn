...
![gui-sample](../images/gui-sample.png)
...
PythonのGUIアプリ開発でのお困りごとのため、ローカルに入ってるバージョンとは違ったpythonを使う必要があったのですが、ちょっとした事情でDockerに頼ることとしました。
...
**WSL内のディレクトリにディレクトリを移動させることで、WSLgディレクトリを正常にマウントできる**ようになりました。
