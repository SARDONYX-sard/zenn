...
![image-size](../images/docker-wslg-template/image-size.png)
...
![WSL-button](./../images/docker-wslg-template/WSL-button.png)

Step 3: 中央に現れたパレットから`Reopen in Container`というを項目を選択します。 (初回のビルドはかなり時間がかかります。)

![remote-container](./../images/docker-wslg-template/remote-container.png)
